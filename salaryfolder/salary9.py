...
def main():
    target_designations = ['Research Analyst', 'Data Analyst', 'Business Analyst',
                           'Consultant']
    ...
    for index, row in filtered_df.iterrows():
        ...
        pd.DataFrame(unsuccessful_companies, columns=['Company Name']).to_csv('unsuccessful_companies11.csv',
                                                                              index=False)
